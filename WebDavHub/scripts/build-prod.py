#!/usr/bin/env python3
"""
CineSync Production Build Script
=================================

This script builds the WebDavHub project for production:
- Installs frontend dependencies (if needed)
- Builds frontend for production (creates dist folder)
- Builds Go backend
- Does NOT start servers (use start-prod.py for that)

Usage: python build-prod.py
       python build-prod.py --help
"""
...
class WebDavHubProductionBuilder:
    def __init__(self):
    ...
    def parse_arguments(self):
        ...
        parser = argparse.ArgumentParser(
            description="CineSync Production Build Script",
    ...
    def build_frontend(self):
        ...
        if not Path("dist").exists():
            print("❌ Frontend build did not create dist folder")
            sys.exit(1)
    ...
    def run(self):
        ...
        try:
            print("🏭 Building WebDavHub for Production...\n")
...
if __name__ == "__main__":
    builder = WebDavHubProductionBuilder()
    builder.run()
