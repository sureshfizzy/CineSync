...
func initializeMediaHubTables(db *sql.DB) error {
	...
	indexes := []string{
		...
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_file_path ON deleted_files(file_path)",
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_destination_path ON deleted_files(destination_path)",
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_base_path ON deleted_files(base_path)",
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_root_folder ON deleted_files(root_folder)",
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_tmdb_id ON deleted_files(tmdb_id)",
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_season_number ON deleted_files(season_number)",
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_media_type ON deleted_files(media_type)",
		"CREATE INDEX IF NOT EXISTS idx_deleted_files_trash_file_name ON deleted_files(trash_file_name)",
